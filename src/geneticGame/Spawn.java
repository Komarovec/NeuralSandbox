...
public class Spawn extends GameObject { 
    ...
    public Spawn(int radius, Playground pg, Point pos, Color fillColor, Color cirColor, double angle) {
        super(pg, pos, fillColor, cirColor, angle);
        this.radius = radius;
    }
    
    public Spawn(int radius, Playground pg, Point pos, double angle) {
        this(radius, pg, pos, Color.YELLOW, Color.BLACK, angle);
    }
    
    public Spawn(int radius, Playground pg, Point pos, Color fillColor, Color cirColor) {
        this(radius, pg, pos, fillColor, cirColor, 0);
    }
    
    public Spawn(int radius, Playground pg, Point pos) {
        this(radius, pg, pos, Color.YELLOW, Color.BLACK, 0);
    }
    
    public Spawn(Playground pg, Point pos) {
        this(pg.getScaledValue(30), pg, pos, Color.YELLOW, Color.BLACK, 0);
    }
